                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 p-r-0 title-margin-right">
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <h1>Hello, {{ Auth::user()->name ?? 'User' }} <br>
                                    <span>
                                        @if(Auth::user()->role === 'admin')
                                            @if(request()->is('coa') || request()->is('coa/*'))
                                                Welcome to COA Dashboard
                                            @elseif(request()->is('pegawai') || request()->is('pegawai/*'))
                                                Welcome to Pegawai Dashboard
                                            @elseif(request()->is('gajijabatan') || request()->is('gajijabatan/*'))
                                                Welcome to Gaji Jabatan Dashboard
                                            @elseif(request()->is('admin/pengeluaran') || request()->is('admin/pengeluaran/*'))
                                                Welcome to Pengeluaran Dashboard
                                            @elseif(request()->is('admin/presensi') || request()->is('admin/presensi/*'))
                                                Welcome to Presensi Dashboard
                                            @elseif(request()->is('admin/laporan/jurnal'))
                                                Welcome to Jurnal Umum Dashboard
                                            @else
