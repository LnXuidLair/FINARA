    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('pegawai.store') }}">
                ...
                <div class="mb-3">
                    <label class="form-label">ID (Otomatis)</label>
                    <input type="text" class="form-control" value="{{ $nextID }}" readonly>
                    <small class="text-muted">ID akan di-generate otomatis</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="id_gaji_jabatan" class="form-select @error('id_gaji_jabatan') is-invalid @enderror" required>
                        ...
                        @foreach($gajiJabatans as $jabatan)
                            <option value="{{ $jabatan->id }}" {{ old('id_gaji_jabatan') == $jabatan->id ? 'selected' : '' }}>
