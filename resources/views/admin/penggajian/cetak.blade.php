...
<head>
    ...
    <title>Slip Gaji - {{ $penggajian->pegawai->nama_pegawai }} - {{ \Carbon\Carbon::parse($penggajian->periode)->format('F Y') }}</title>
    ...
    <div class="container">
        <div class="slip-gaji">
            ...
            <div class="info-pegawai">
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Nama Karyawan</strong>: {{ $penggajian->pegawai->nama_pegawai }}</p>
                        <p><strong>Jabatan</strong>: {{ $penggajian->pegawai->jabatan }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>NIP</strong>: {{ $penggajian->pegawai->nip ?? '-' }}</p>
            ...
            <table class="table-detail">
                ...
                <tbody>
                    <tr>
                        <td>Gaji per Hari</td>
                        <td class="text-right">Rp {{ number_format($penggajian->gaji_perhari, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
