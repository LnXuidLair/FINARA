...
@section('title', 'Tambah Tagihan Siswa')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Tambah Tagihan Siswa</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('admin.tagihan-siswa.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="siswa_id" id="siswa_id" class="form-select" required>
                                        ...
                                        @foreach($siswa as $s)
                                            <option value="{{ $s->id }}" 
                                                ...
                                                {{ $s->nama_siswa }} ({{ $s->nis }}) - {{ $s->orangtua->nama_ortu ?? 'Tidak ada orang tua' }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_tagihan" id="jenis_tagihan" class="form-select" required>
                                        ...
                                        <option value="SPP" {{ old('jenis_tagihan') == 'SPP' ? 'selected' : '' }}>SPP</option>
                                        <option value="Uang Kegiatan" {{ old('jenis_tagihan') == 'Uang Kegiatan' ? 'selected' : '' }}>Uang Kegiatan</option>
                                        <option value="Daftar Ulang" {{ old('jenis_tagihan') == 'Daftar Ulang' ? 'selected' : '' }}>Daftar Ulang</option>
                                        <option value="Uang Buku" {{ old('jenis_tagihan') == 'Uang Buku' ? 'selected' : '' }}>Uang Buku</option>
                                        <option value="Uang Seragam" {{ old('jenis_tagihan') == 'Uang Seragam' ? 'selected' : '' }}>Uang Seragam</option>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jumlah" id="jumlah" class="form-control" 
                                           value="{{ old('jumlah') }}" required min="1000" step="1000">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_jatuh_tempo" id="tanggal_jatuh_tempo" 
                                           class="form-control" value="{{ old('tanggal_jatuh_tempo') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="periode" id="periode" class="form-control" 
                                           value="{{ old('periode') }}" placeholder="Contoh: Januari 2025">
